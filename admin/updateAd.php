...
$table_id = $_GET['id'];
$jurnalTable = mysqli_query($connect, "SELECT * FROM `users` WHERE `id` = '$table_id'");
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-floating mb-3">
                        <input name="login" type="text" class="form-control" id="floatingInputValue" placeholder="name@example.com" value="<?= $jurnalTable['login']?>">
                        <label for="floatingInputValue">Логин</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input name="password" type="text" class="form-control" id="floatingInputValue" placeholder="name@example.com"  value="<?= $jurnalTable['password']?>">
                        <label for="floatingInput">Пароль</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input  name="fio" type="text" class="form-control" id="floatingInputValue" placeholder="name@example.com" value="<?= $jurnalTable['fio']?>">
