...
<section>
    <div class="container">
        <table class="table table-dark table-hover border">
            ...
            $jurnalTables = mysqli_query($connect, "SELECT * FROM `users`");
            ...
            $jurnalTables = mysqli_query($connect, "SELECT * FROM `users` ORDER BY `id` DESC LIMIT $startFrom, $showRecordPerPage");//подключения и выбор всей таблицы
