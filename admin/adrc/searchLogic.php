...
$sqlQuery = "SELECT * FROM `jurnarelements` WHERE `faim` LIKE '%$search_get%'";
$select = mysqli_query($connect, $sqlQuery);
...
<section class="form_add_elemets">
    ...
    <div class="container form_buttons">
        ...
        <div class="search">
            ...
            <form class="d-flex" method="get" action="searchLogic.php" id="search">
...
<!-- tabel -->
<h2 class="searchTitle">Поискавой запрос: <? echo $_GET['search']?></h2>
<section>
    <div class="container">
